...
public class Booking extends javax.swing.JFrame { 
   ...
   private void tampilkan_data(){
    ...
    private void initComponents() {
        ...
        jLabel27.setText("Pemesanan Kamar__________________");
        ...
        tabelkaryawan.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama", "No. KTP", "Alamat", "No. HP", "Tanggal", "Tipe"
            }
        ) {
        ...
        jLabel20.setForeground(new java.awt.Color(0, 144, 254));
        jLabel20.setText("Tanggal");

        jLabel24.setFont(new java.awt.Font("Segoe UI Symbol", 1, 18)); // NOI18N
        jLabel24.setForeground(new java.awt.Color(0, 144, 254));
        jLabel24.setText(":");
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(Alamat, javax.swing.GroupLayout.DEFAULT_SIZE, 412, Short.MAX_VALUE)
                                            .addComponent(HP, javax.swing.GroupLayout.DEFAULT_SIZE, 412, Short.MAX_VALUE)
                                            .addComponent(Tanggal, javax.swing.GroupLayout.DEFAULT_SIZE, 412, Short.MAX_VALUE)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(HP, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel18)
                    .addComponent(jLabel23))
                .addGap(12, 12, 12)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Tanggal, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tblsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tblsimpanActionPerformed
        // TODO add your handling code here:  
        try {
            String sql = "INSERT INTO data VALUES ('"+Name.getText()+"','"+KTP.getText()+"','"+Alamat.getText()+"','"+HP.getText()+"','"+Tanggal.getText()+"','"+Tipe.getSelectedItem()+"')";
            java.sql.Connection conn = (Connection)Konfig.configDB();
    ...
    private void tblhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tblhapusActionPerformed
        // TODO add your handling code here:  
        try {
            String sql = "DELETE FROM data WHERE Nama='"+Name.getText()+"'";
        java.sql.Connection conn = (Connection)Konfig.configDB();
            java.sql.PreparedStatement pstm = conn.prepareStatement(sql);
            pstm.execute();
    ...
    private void tblupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tblupdateActionPerformed
        // TODO add your handling code here 
        try {
            String sql = "UPDATE data SET Nama='"+Name.getText()+"',KTP='"+KTP.getText()+"',Alamat='"+Alamat.getText()+"',HP='"+HP.getText()+"',Tanggal='"+Tanggal.getText()+"',Tipe='"+Tipe.getSelectedItem()+"' WHERE Nama = '"+Name.getText()+"'";
            java.sql.Connection conn = (Connection)Konfig.configDB();
            java.sql.PreparedStatement pstm = conn.prepareStatement(sql);
            pstm.execute();
    ...
    private void tabelkaryawanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelkaryawanMouseClicked
        ...
        String tanggal = tabelkaryawan.getValueAt(baris, 5).toString();
